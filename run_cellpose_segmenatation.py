...
'''
# laod model
os.chdir(r'D:\Gil\AIPS\cellpose\cellpose_aips-main\models')
...
path_norm = r'D:\Gil\AIPS\cellpose\cellpose_aips-main\raw'
os.chdir(path_norm)
